...
-  Type: -
-  Contact:
-  API Type: REST, `R package <https://r.sysrev.com/>`__,
   `Python <https://github.com/sysrev/PySysrev>`__
...
-  Provided by:
-  Citation: https://doi.org/10.3389/frai.2021.685298
-  Version:
-  License:
-  Source Code:
-  Docker:
-  Bio.tools: https://bio.tools/sysrev
-  TeSS:
